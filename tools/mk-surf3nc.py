...
но они невыпуклые поэтому спецалгоритм
nc = nonconvex
"""
...
for i in range(0,N):
    ...
    fname = dir + "/" + str(i)+".txt"
    print("processing i=",i,"fname=",fname)
    with open(fname, "r") as file:
        ...
        # https://github.com/linuxlewis/tripy/blob/master/tripy.py
        print("loaded ",len(coordinates2d),"points. making triangles")
        triangles = earclip(coordinates2d)
        print("made ",len(triangles),"triangles")
        # https://stackoverflow.com/questions/7370801/how-do-i-measure-elapsed-time-in-python

        for t in triangles:
            surf.append( [t[0][0], t[0][1], z_value] )
            surf.append( [t[1][0], t[1][1], z_value] )
            surf.append( [t[2][0], t[2][1], z_value] )

        """ простой негодный алгоритм
        pt0 = coordinates[0]        
